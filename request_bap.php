    ...
    <div class="row my-5 ">
        ...
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0">
                    <h2 class="text-center">Baptismal Records Request</h2>
                    ...
                    <?php  $code = uniqid('TICKET_'); ?>
                        ...
                        <input type="hidden" name="type" value = "Baptismal">
                        <div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="baptizee" name="baptizee" required placeholder="John Smith">
                                <small class="px-3 text-muted">Baptizee's Name</small>
                            </div>
                            <div class="col-md-6">
