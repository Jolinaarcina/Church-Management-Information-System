                ...
                <div class="card-body">
                    <form action="" id="search_record">
                        ...
                        <div class="form-group">
                            <label for="name" class="control-label text-navy">Baptizee's Name</label>
                            <input type="text" class="form-control form-control-border" placeholder="Search by Baptizee's Name" name="name">
