            ...
            <table class="table table-borderless table-striped">
                ...
                <tbody>
					<?php 
                        ...
                        $sql = "SELECT * from `confirmation_list` {$search} order by unix_timestamp(`fullname`) asc ";
						$qry = $conn->query($sql);
					...
					?>
						<tr>
							...
							<td align="center">
								<h3><a href="./?page=request_confirmation" class="text-muted" target=""><i class="fa fa-external-link-alt text-secondary opacity-75"></i> Request Record</a></h3>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
