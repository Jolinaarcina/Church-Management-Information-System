...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-gradient-black">
        ...
        <span class="brand-text font-weight-light"><?php echo $_settings->info('church_name') ?></span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=members" class="nav-link nav-mass_guide">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=sms" class="nav-link nav-mass_guide">
