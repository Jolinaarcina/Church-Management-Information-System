...
if(isset($_GET['id'])){
    ...
    echo "<script>alert('Unknown members ID'); location.replace('./?page=members');</script>";
    }
}
else{
    echo "<script>alert('members ID is required'); location.replace('./?page=members');</script>";
}
?>
<style>
    @media screen {
