              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=records" class="nav-link nav-records">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=matrimony" class="nav-link nav-matrimony">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=confirmation" class="nav-link nav-confirmation">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=collection
                      " class="nav-link nav-collection">
                    ...
                    <!-- <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=sms" class="nav-link nav-send_sms">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=mass_guide" class="nav-link nav-mass_guide">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/calendar" class="nav-link nav-calendar">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=brgy" class="nav-link nav-brgy_list">
                        <i class="nav-icon fas fa-users-cog"></i>
                        <p>
                          Barangay List
                        </p>
