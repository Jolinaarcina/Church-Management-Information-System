...
<div class="col-lg-12">
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			...
			<fieldset>
				<legend>Church's Information</legend>
				<div class="form-group">
					<label for="church_name" class="control-label">Name</label>
					<input type="text" class="form-control form-control-sm" name="church_name" id="church_name" value="<?php echo $_settings->info('church_name') ?>">
				</div>
				<div class="form-group">
					<label for="church_name" class="control-label">Diocese</label>
					<input type="text" class="form-control form-control-sm" name="diocese" id="diocese" value="<?php echo $_settings->info('diocese') ?>">
				</div>
				<div class="form-group">
					<label for="religion" class="control-label">Religion</label>
					<input type="text" class="form-control form-control-sm" name="religion" id="religion" value="<?php echo $_settings->info('religion') ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="address" class="control-label">Priest</label>
					<textarea rows="3" class="form-control form-control-sm" name="priest" id="priest" style="resize:none"><?php echo $_settings->info('priest') ?></textarea>
				</div>
			</fieldset>
			</form>
		</div>
